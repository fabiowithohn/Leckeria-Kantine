          ...
          <div className="mx-auto mt-12 grid max-w-4xl gap-6 md:grid-cols-2">
            {SERVICES.map((s) => (
              ...
              >
                ...
                />
                <span className={`relative grid h-14 w-14 place-items-center rounded-2xl ${s.color} transition-transform duration-300 group-hover:scale-110`}>
                ...
                <h3 className="relative mt-5 text-xl text-ink">{s.title}</h3>
                <p className="relative mt-2 text-ink-soft">{s.text}</p>
                <span className="relative mt-4 inline-flex items-center gap-1 text-sm font-extrabold text-brand-500">
                  Mehr erfahren
